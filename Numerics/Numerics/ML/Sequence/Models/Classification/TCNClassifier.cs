...
/// <summary>
/// Temporal Convolutional Network classifier: <c>TCNBlock → GlobalAvgPool → Dense → Softmax</c>.
/// </summary>
public class TCNClassifier : TCNModelBase, IClassificationModel
{
    ...
    {
        var clone = new TCNClassifier { NumClasses = NumClasses };
